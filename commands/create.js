...
const { setup_state } = require('../../MemeBot/state');
...
function createCommand(ctx) {
  ...
  function askToAddBotToGroup(ctx) {
    ...
    // Save the chat ID to the setup_state with the step as 'askToAddBotToGroup'
    setup_state[chatId] = { step: 'askToAddBotToGroup' };
  }
